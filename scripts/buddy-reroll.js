...
// Bun.hash results match actual Claude Code native; Node.js (FNV-1a) matches npm install.
//
// Usage:
//   node buddy-reroll.js [options]    # runs with FNV-1a (Node mode, for npm installs)
//   bun  buddy-reroll.js [options]    # runs with Bun.hash (Bun mode, for native installs)
//
// Options:
...
console.log(`Runtime: ${runtimeLabel}${isBun ? '' : ' (matches npm install)'}`)
